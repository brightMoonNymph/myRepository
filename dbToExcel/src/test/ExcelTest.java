...
import util.GetTableColumns;

public class ExcelTest {
	public static void main(String[] args) throws SQLException, IOException {
		// TODO Auto-generated method stub
//		String localExcelFilePath = "C:/Users/强/Desktop/ExcelTitle22222211222.xls";
...
//				System.out.println(customerList.get(i));
					...
					//微信结果为空，数据库无此字段
					Label label_3 = new Label(excelColumn++,i+1,"");
					//4S店为空
					Label label_4 = new Label(excelColumn++,i+1,"");
					//领取时间
					...
					//buick结果为空
					Label label_7 = new Label(excelColumn++,i+1,"");
					//Buick流水号
					...
					if("1900-01-01 00:00:00".equals(temp)){
						...
						Label label_10 = new Label(excelColumn++,i+1,format.format(customerList.get(i).getCustomer_follow_link_date()));
						firstSheet.addCell(label_10);
					}
					//卡券类型
					...
					//商户编码为空
					Label label_14 = new Label(excelColumn++,i+1,"");
					//卡ID
